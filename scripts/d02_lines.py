...
# Get lines
# Request     Potentially accessible stream isolated or potentially isolated by barriers from D1:

streams = geopandas.read_file(
    "https://features.hillcrestgeo.ca/bcfishpass/collections/bcfishpass.streams/items.json?filter=watershed_group_code=%27BULK%27%20and%20access_model_ch_co_sk%20like%20%27POTENTIALLY%20ACCESSIBLE%25%27"
).to_crs("EPSG:3005")
...
streams.plot(ax=ax, color="#f85a65", zorder=100)  # ensure streams are plotted on top.
